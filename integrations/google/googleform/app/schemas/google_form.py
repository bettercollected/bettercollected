...
class GoogleFormDocument(BaseDocument, GoogleFormDto):
    """
    GoogleFormDocument is a subclass of both MongoDocument and GoogleFormDto.
    It represents a collection of Google Forms stored in a MongoDB database.

    Attributes:
        provider (str, optional): The provider of the Google Form.
        dataOwnerFields (List[str], optional): A list of fields that contain
            data owned by the provider of the Google Form.
