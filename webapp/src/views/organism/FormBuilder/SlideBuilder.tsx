                                        ...
                                        <Draggable key={field.id} draggableId={`${field.id}`} index={index} disableInteractiveElementBlocking={disabled} isDragDisabled={disabled}>
                                            {(provided) => (
                                                <div
                                                    ...
                                                    className={cn('relative flex h-full w-full flex-row  items-center', slide.properties?.layout === FormSlideLayout.SINGLE_COLUMN_NO_BACKGROUND_LEFT_ALIGN ? 'justify-start' : 'justify-center')}
                                                >
                                                    <div
                                                        key={index}
                                                        tabIndex={0}
