...
export type UPGRADE_MODAL_VIEW = 'LOGIN_VIEW' | 'FORM_BUILDER_PREVIEW' | 'CROP_IMAGE' | 'UPGRADE_TO_PRO' | 'WORKSPACE_PREVIEW' | '' | 'CREATE_CONSENT_FULL_MODAL_VIEW' | 'CONSENT_FULL_MODAL_VIEW' | 'FORM_SETTINGS_FULL_MODAL_VIEW' ;
