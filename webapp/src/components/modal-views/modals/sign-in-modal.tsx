    ...
    return (
        <div className="!mt-0">
            <div className="absolute top-0 left-0 w-full flex flex-col xl:flex-row ">
                ...
                <div className="flex flex-col order-1 !bg-brand-100 xl:order-2 items-start justify-start xl:justify-center px-8 xl:py-[28px] h-screen xl:h-[687px] w-screen xl:w-[547px]">
                    <Logo isLink={false} />
