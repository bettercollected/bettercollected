...
export default function CreateConsentFullModalView({ onFormPublish, form, isPreview = false }: CreateConsentFullModalProps) {
    ...
    return (
        <div className={cn('flex w-full min-h-screen !bg-white', isPreview && '!bg-transparent pt-40 !min-h-full overflow-hidden')}>
            ...
            <div className={cn('mt-12 w-full bg-white', isPreview && 'rounded-t-3xl !mt-0 !pt-12 overflow-y-auto scroll-mt-6')}>
