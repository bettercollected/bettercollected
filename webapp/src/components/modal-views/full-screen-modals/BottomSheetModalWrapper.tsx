...
export default function BottomSheetModalWrapper({children}: { children?: ReactNode }) {
    ...
    return (
        <div className={cn('flex w-full min-h-screen !bg-transparent pt-40 overflow-hidden')}>
            ...
            <div className={cn(' w-full bg-white min-h-screen rounded-t-3xl px-5 md:px-20 lg:px-30 !mt-0 !pt-12 overflow-y-auto scroll-mt-6')}>
                {children}
            </div>
        </div>
    )
