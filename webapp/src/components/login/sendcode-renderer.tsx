    ...
    return (
        <div className="flex flex-col justify-center">
            <form onSubmit={handleClick}>
                ...
                <FormInput inputFieldType="email" value={emailInput} placeholder={'Enter your email'}
                           onChange={handleChangeOnInput} handleValidation={handleValidation}/>
                <Button type="submit" disabled={!emailValid} isLoading={isLoading} variant="solid"
                        className={`mt-2 w-full mb-0`} onClick={handleClick}>
                    Get in
                </Button>
                ...
                <button type="submit" className="bg-[#1a73e8]" onClick={handleGoogleOauthLogin}>
