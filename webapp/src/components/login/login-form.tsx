    ...
    const renderHeader = () => (
        <div className={'flex justify-between mb-24'}>
            <div className="flex justify-center items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-17 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    return (
        <div className="flex justify-center sm:p-12 md:w-1/2">
            <div className="w-full">
                {renderHeader()}
                <div className={'mb-6'}>
                    <div className={'font-normal text-2xl'}>{t('LOGIN').toUpperCase()}</div>
                    <p className={'text-gray-500'}>{t('LOGIN_TITLE_SLOGAN')}</p>
                </div>

                <IconsRender IconsArray={IconsArray} />

                <p className={'flex justify-center font-normal text-gray-500'}>{t('OR')}</p>

                <div className="mt-4">
                    <label className="block text-sm">{t('EMAIL')}</label>
                    <input type="email" className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600" placeholder={t('EMAIL_ADDRESS')} />
                </div>
                ...
                <div className="mt-4 text-center">
                    <p className="text-sm">
                        ...
                        <a href="@app/pages/Login/login#" className="text-blue-600 hover:underline">
                            {' '}
                            Sign up
                        </a>
                    </p>
