    ...
    return (
        <SettingsCard className={`!mt-5 relative p-5 lg:p-10 ${!isProPlan && updateDomain ? '!bg-brand-200' : ''}`}>
            ...
            <div className="flex flex-col w-full justify-between">
                <div
                    className="w-full text-sm mb-10 text-black-700">{updateDomain ? t(updateWorkspace.domain.desc) : t(updateWorkspace.handles.desc)}</div>
                <div
                    className="w-full body6 mb-4 !font-semibold text-black-900">{t(updateWorkspace.common.consequence)}</div>
                ...
                <div className="flex space-between items-end w-full">
                    <div className="flex-1">
                        ...
                        <div
                            className="flex flex-col md:flex-row gap-4 space-y-4 md:space-y-0 md:items-center space-between">
