    ...
    return (
        <LandingPageSectionContainer sectionId={'features'}>
            ...
            <div className={'grid grid-rows-1 lg:grid-rows-2 lg:grid-flow-col lg:gap-6 '}>
                ...
                <FeaturesContainer>
                    <CardContent title={t('FEATURE_2')} description={t('FEATURE_2_DESC')} imageSrc={form} />
                </FeaturesContainer>

                <FeaturesContainer>
                    <CardContent title={t('FEATURE_3')} description={t('FEATURE_3_DESC')} imageSrc={Vector} />
                </FeaturesContainer>

                <FeaturesContainer>
                    <CardContent title={t('FEATURE_4')} description={t('FEATURE_4_DESC')} imageSrc={data} />
                </FeaturesContainer>
            </div>
            {/*</div>*/}
