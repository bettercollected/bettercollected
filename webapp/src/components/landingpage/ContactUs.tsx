            ...
            <LandingPageSectionContainer sectionId={"contact"}>
                ...
                <div className={"lg:flex lg:items-center shadow-md"}>
                    {dimensions.width <= 1024 ? <></> :
                        <div
                            className={"h-full w-full p-4 bg-[url('/contact_us.svg')] bg-no-repeat bg-center bg-cover"}>
                            <h2 className={"text-white font-semibold text-sm md:text-md lg:text-2xl text-center"}>Leave
                                us a message!</h2>
                        </div>}

                    <div className={"m-auto lg:flex-shrink-0 lg:flex-grow-0 lg:basis-[50%]"}>
                        <FormRenderer handleSubmit={handleSubmit}>
                            <h2 className={"text-roboto font-semibold text-xl md:text-2xl lg:text-3xl text-center"}>Enter
                                your information</h2>
                            <FormInput
                                label={"Your Name"}
