    ...
    function Pricing() {
        return (
            <div className="flex justify-center items-baseline my-8">
                ...
                <span className={`${props.recommended ? 'text-white' : 'text-gray-500'}`}>
    ...
    function GetStartedButton() {
        ...
        return (
            ...
            <a href={formUrl} rel={'noreferrer'} target={'_blank'}>
                <div className={'p-2 md:p-4 text-center md:pt-2 md:pb-2 text-white rounded-md bg-[#007aff] hover:bg-[#4da2ff]'}>Get Started</div>
            </a>
        );
    }
