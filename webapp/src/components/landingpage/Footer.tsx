...
export default function Footer() {
    ...
    return (
        <div className={"flex bg-[#f5faff] border-[#b8daff] border-t-[1px] justify-around items-start p-4 "}>
            ...
            <div className={"flex flex-col"}>
                ...
                <h3 className={"font-semibold text-md cursor-pointer hover:text-gray-500"}>Privacy Policy</h3>
            </div>
        </div>
    )
}