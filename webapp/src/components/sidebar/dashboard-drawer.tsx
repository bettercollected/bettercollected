        ...
        <>
            ...
            <Box sx={{overflow: 'auto', height: '100%'}}>
                <div className="flex h-full flex-col justify-between">
                    <div>
                        <List disablePadding sx={{paddingY: '20px', paddingX: '20px'}}
                              className={JOYRIDE_CLASS.WORKSPACE_SWITCHER}>
                            <ListItem disablePadding>
                                <WorkspaceMenuDropdown fullWidth/>
                            </ListItem>
                        </List>
                        <NavigationList className={JOYRIDE_CLASS.WORKSPACE_NAVIGATION}
                                        sx={{paddingY: '8px', paddingX: '20px'}} navigationList={topNavList}/>
                        {isAdmin && (
                            <>
                                <Divider/>
                                <NavigationList className={JOYRIDE_CLASS.WORKSPACE_ADVANCE_NAVIGATION}
                                                sx={{paddingY: '8px', paddingX: '20px'}}
                                                navigationList={bottomNavList}/>
                            </>
                        )}
                    </div>
                    {isAdmin && !isProPlan && (
                        <div>
                            ...
                            <div className="px-5 py-6">
                                ...
                                <LinearProgress className="my-5 py-[2px]" variant="determinate" value={data?.forms || 0}
                                                color="inherit"/>
                                <div className="body4">
