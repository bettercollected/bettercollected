        ...
        <AnimatePresence mode="wait" initial={true} onExitComplete={() => window.scrollTo(0, 0)}>
            <div className="relative min-h-screen w-full">
                ...
                <DrawerComponent drawerWidth={drawerWidth} mobileOpen={mobileOpen}
                                 handleDrawerToggle={handleDrawerToggle} topNavList={topNavList}
                ...
                <Box
                    ...
                    <div className="flex flex-col w-full">
                        <div
                            className="flex w-full py-3 z-[1000] sticky top-[68px] lg:top-0 bg-white justify-between px-5 border-b border-b-black-200 lg:px-10 items-center">
