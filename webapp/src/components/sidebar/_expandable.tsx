...
export default function SidebarExpandable() {
    ...
    const className = 'top-[68px] hidden border-r-[1px] sm:block relative h-[calc(100%-4rem)]';
    ...
    return (
        <aside
            ...
            className={cn(
                ...
                'top-0 z-40 h-full w-full max-w-full  bg-white duration-200 ltr:left-0 rtl:right-0  dark:border-gray-700 dark:bg-dark xl:fixed',
                className
            )}
        >
                ...
                <div className="h-full px-6 pb-5 2xl:px-8">
                    {!open ? (
                        <div className="flex h-full flex-col justify-between">
                            ...
                            <FooterRenderer icon={<Logout className={'!w-5 !h-5'} />} profileName={selectGetStatus?.data?.user?.sub} />
                        </div>
                    ) : (
                        <div className="flex h-full flex-col justify-between">
