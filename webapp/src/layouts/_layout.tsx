...
export default function Layout({
    ...
    return (
        <div className="!min-h-screen !min-w-full !bg-brand-100 dark:bg-dark z-20">
            ...
            <Box className={`float-none lg:float-right ${showNavbar ? '!min-h-calc-68 !mt-[68px] ' : 'min-h-screen'} w-full px-5  !bg-brand-100 lg:px-10 ${className}`} component="main" sx={{ display: 'flex', width: '100%' }}>
