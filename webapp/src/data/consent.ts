    ...
    importanceDescription: [
        {
            ...
            description: "This page enables you to communicate your intentions clearly. When responders understand how their data will be used, they're more likely to engage willingly."
        },
        {
            title: 'Privacy Matters:',
            description: "Demonstrating your commitment to data privacy builds a strong foundation of trust. It shows that you value your responders' information and treat it with respect."
        }
    ]
};
