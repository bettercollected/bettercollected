    ...
    return (
        <div className="relative">
            ...
            <ContentLayout className="!pt-0 relative bg-[#FBFBFB]">
                ...
                <div className="product-box">
                    <div className="product-image absolute border-[1px] border-neutral-100 hover:border-blue-100 rounded-full z-10 h-24 w-24 sm:h-32 sm:w-32 md:h-40 md:w-40 xl:h-40 xl:w-40 2xl:h-[180px] 2xl:w-[180px] overflow-hidden -top-12 sm:-top-16 md:-top-20 xl:-top-[88px] 2xl:-top-24">
                    ...
                    <div className="pt-3 md:pt-7">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {[1, 2, 3, 4, 5, 6].map((form) => (
                                <div key={form} className="flex flex-row items-center gap-8 p-5 drop-shadow-sm hover:drop-shadow-md transition cursor-pointer bg-white rounded-[20px]">
                                    ...
                                    <div className="p-2 border-[1px] border-white hover:border-darkGrey rounded-md">
