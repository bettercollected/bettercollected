...
import DashboardDrawerApp from '@app/Components/sidebar/DashboardDrawerApp';
import LocaleDropdownUiApp from '@app/Components/ui/LocaleDropdownUiApp';
...
export default function SidebarLayoutApp({ children, DrawerComponent = DashboardDrawerApp, boxClassName = '' }: ISidebarLayout) {
