...
export default function GreenCircularCheck(props: React.SVGAttributes<any>) {
    return (
        <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <defs>
                <filter id="filter0_d_4220_6128" x="5.99996" y="12" width="29.0001" height="22.6826" filterUnits="userSpaceOnUse">
                    ...
                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_4220_6128" />
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_4220_6128" result="shape" />
                </filter>
            </defs>
        </svg>
    );
