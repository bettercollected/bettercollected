    ...
    return (
        <HeaderModalWrapper headerTitle="Add Custom Domain">
            <form onSubmit={handleSubmit}>
                <div className="text-start max-w-full mb-4 body4 !text-pink-500">
                    {t('UPGRADE.FEATURES.CUSTOM_DOMAIN.NOTE')}
                </div>
                ...
                />
                <AppButton className="w-full mt-4" data-testid="save-button" type="submit" isLoading={isLoading}
