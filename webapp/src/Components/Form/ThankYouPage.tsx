...
export default function ThankYouPage({isPreview}: IThankYouPageProps) {
    ...
    return (
        <div className="flex w-full flex-col items-center justify-start h-full text-center">
            <div
                className="w-full aspect-banner-mobile  lg:aspect-thank_you_cover  relative flex items-center justify-center">
                <Image src="/images/thankyou_cover.png" layout="fill" objectFit="cover" alt="ALternative"/>
                <svg className="w-16 h-16 md:w-20 md:h-20  lg:w-24 lg:h-24" viewBox="0 0 100 100" fill="none" style={{
                    zIndex: 1
                }}
            ...
            <div className="p1 mt-4 text-black-800">
