...
import { useCreateWorkspaceMutation } from '@app/store/workspaces/api';

const SetUpWorkspace = () => {
    const [createWorkspace] = useCreateWorkspaceMutation();

    const [workspaceForm, setWorkspaceForm] = useState({ title: '', workspaceName: '', description: '', profileImage: '', bannerImage: '' });
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            ...
                            <div className="">
                                ...
                                <input type="text" onChange={handleChange} name="workspaceName" className="bg-gray-50 border-solid border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5" placeholder="workspace name" required />
                            </div>
                            <div className="">
