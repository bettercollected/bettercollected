...
export default function FormPage(props: any) {
    ...
    const breadcrumbsItem = [
        ...
        {
            title: ['xs'].indexOf(breakpoint) !== -1 ? toEndDottedStr(formId, 10) : formId
        }
    ];
            ...
            <div className="flex flex-col w-full m-auto justify-center">
                <ParamTab tabMenu={tabs}>
                    ...
                    <TabPanel className="focus:outline-none" key="submissions">
                        <FormSubmissionsTab workspace={props.workspace} workspaceName={props?.workspace?.workspaceName}
                                            workspaceId={props?.workspace?.id ?? ''} formId={formId}/>
                    </TabPanel>
